...
describe('healtRepository', () => {
  ...
  it('should call cacheManager.checkConnection and return its result', async () => {
    ...
    (cacheManager.checkConnection as ReturnType<typeof vi.fn>).mockResolvedValue(mockResult);
  ...
  it('should return null if cacheManager.checkConnection fails', async () => {
    // Arrange
    (cacheManager.checkConnection as ReturnType<typeof vi.fn>).mockResolvedValue(null);
