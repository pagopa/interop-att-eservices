...
export type DigitalAddress = z.infer<
  typeof api.schemas.Digital_Address
>;
...
export type UsageInfo = z.infer<
  typeof api.schemas.Usage_Info
>;
...
>;
export type PracticalReference = z.infer<
typeof api.schemas.PracticalReference
>;
