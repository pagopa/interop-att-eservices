...
const endpoints = makeApi([
  {
    method: "post",
    path: "/residence-verification-direct",
    alias: "AR001",
  ...
  {
    method: "post",
    path: "/residence-verification-direct/check",
    alias: "AR002",
  ...
  {
    method: "post",
    path: "/residence-verification-direct/data-preparation",
    alias: "InsertAR001",
    description: `Insert data preparation residence-verification-direct`,
    requestFormat: "json",
    parameters: [
      {
        name: "body",
  ...
  {
    method: "get",
    path: "/residence-verification-direct/data-preparation/:uuid",
    alias: "GetByIdAR001",
    description: `Insert data preparation residence-verification-direct`,
    requestFormat: "json",
    parameters: [
  ...
  {
    method: "get",
    path: "/residence-verification-direct/status",
    alias: "getStatus",
