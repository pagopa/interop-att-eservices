...
export type DataTypeRquestFS001 = z.infer<
  typeof api.schemas.DataTypeRquestFS001
>;
...
export type DataSubjectsInstitution = z.infer<
  typeof api.schemas.DataSubjectsInstitution
>;
export type InfoInstitutionType = z.infer<
  typeof api.schemas.InfoInstitutionType
>;
export type TypeInfoValue = z.infer<typeof api.schemas.TypeInfoValue>;
export type CompleteSubjectBindingType = z.infer<
  typeof api.schemas.CompleteSubjectBindingType
>;
