...
import { DataPreparationTemplate, UserModel } from "../model/domain/models.js";
import dataPreparationRepository from "../repository/dataPreparationRepository.js";
import { dataPreparationTemplateToUserModel } from "../model/domain/apiConverter.js";
...
class DataPreparationService {
  ...
  private key: string = "family-status";

  public async saveList(
    request: DataPreparationTemplate
    ...
    try {
      ...
      const hash = generateHash([this.key, this.appContext.authData.purposeId]);
