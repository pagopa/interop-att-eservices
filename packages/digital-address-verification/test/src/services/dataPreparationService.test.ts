...
describe("dataPreparationRepository", () => {
  ...
  describe("findAllByKey", () => {
    it("should retrieve and parse the saved object", async () => {
      ...
      (
        parseJsonToResponseRequestDigitalAddressArray as ReturnType<
          typeof vi.fn
        >
      ...
      ).toHaveBeenCalledWith(mockSavedData);
      expect(logger.info).toHaveBeenCalledWith(
  ...
  describe("findByPurposeId", () => {
    it("should retrieve and find the fiscal code", async () => {
      ...
      (
        findFiscalcodeModelByFiscalcode as ReturnType<typeof vi.fn>
      ).mockReturnValue(mockFoundData);
      ...
      expect(findFiscalcodeModelByFiscalcode).toHaveBeenCalledWith(
        mockParsedData,
        mockFiscalCode
      );
      expect(logger.info).toHaveBeenCalledWith(
