...
import generateHash, { generateHashFromString } from '../../../src/utilities/hashUtilities.js';
...
describe('generateHash', () => {
  ...
  it('should generate the correct SHA-256 hash for an empty array', () => {
    const input: string[] = [];
    const expectedHash = 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855'; // Hash of an empty string
